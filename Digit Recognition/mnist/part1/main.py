...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print('softmax test_error (mod3) =', compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter))
...
#print('softmax test_error (mod3 full) =', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print('SoftMax Error Using PCA: ', test_error)
...
print('SoftMax Error Using PCA and cubic features: ', test_error)